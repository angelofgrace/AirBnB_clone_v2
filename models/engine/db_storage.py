...
class DBStorage():
    ...
    def all(self, cls=None):
        instance_dict = {}
        # If there is no class we go through the
        # classes in the classes in filestorage
        # After we find the class we append it
        # to the isstance.id and add it to the new dict
        if cls is None:
